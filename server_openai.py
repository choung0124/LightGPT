...
async def stream_generator(prompt_id: str):
    ...
    completion = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a domain expert in everything related to light and its relations to neurological disorders such as Alzheimer's and Parkinson's"},
